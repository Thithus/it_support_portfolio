# ☁️ Microsoft 365 Administration & Troubleshooting Homelab Portfolio

Welcome to my Microsoft 365 hands-on lab portfolio.

This repository section showcases practical, ticket-based Microsoft 365 administration and troubleshooting simulations designed to reflect real-world Tier 1 / Tier 2 IT Support and enterprise cloud support scenarios.

All labs were performed in a Microsoft 365 trial tenant environment and documented using structured helpdesk methodology, admin center workflows, and service validation screenshots.
...
Simulated Microsoft Teams access failure caused by disabled service assignment and restored access through workload reactivation.
...
Simulated mailbox access failure by disabling Exchange Online services and restoring functionality through license service remediation.
...
Provisioned a departmental shared mailbox and resolved user access failure through delegation and permission assignment.
...
Simulated cloud storage access failure caused by disabled SharePoint (OneDrive backend) services and restored sync functionality through service reactivation.
